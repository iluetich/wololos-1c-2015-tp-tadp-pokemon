...
class ActividadesTest extends FunSuite {
  ...
  def fixture = new {
      ...
      1, 0, Macho, 30, 1000, 5, 90, 20, SubirDeNivel(100), 0, null)
      
      val charmander = new Pokemon(Bueno, List(embestida), Fuego, Normal ,
      1, 0, Hembra, 990, 1000, 5, 80, 50, UsarUnaPiedra, 0, null)
      ...
      7, 80, Macho, 500, 800, 8, 20, 50, Intercambiar, 0, null)
      ...
      5, 0, Macho, 400, 500, 9, 80, 60, UsarUnaPiedraLunar, 0, null)
      
      val hitmonchan = new Pokemon(Bueno, List[Ataque](), Pelea, Normal ,
      1, 0, Macho, 450, 600, 9, 20, 80, Intercambiar, 0, null)
      
      val hunter = new Pokemon(Bueno, List[Ataque](), Fantasma, Normal ,
      1, 0, Hembra, 450, 600, 15, 20, 80, SubirDeNivel(100), 0, null)
      
      val voltod = new Pokemon(Bueno, List(), Electrico, Tierra ,
      1, 0, Hembra, 60, 800, 5, 95, 40, SubirDeNivel(100), 0, null)
  }
